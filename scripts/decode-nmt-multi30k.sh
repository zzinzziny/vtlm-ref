...
# Check the Checkpoint's folder to see the created folders that contain the hypotheses and refs.

CKPT="/data/IMT/VTLM/models/vtlm-on-multi30k_best_valid_ftune_nmt_vtlm_bs64_lr0.00001/s5azavca7k/best-valid_en-de_mt_bleu.pth"
